...
## 2024-05-19 - Pre-computing Static NumPy Arrays in OCR Loops
**Learning:** In high-frequency computer vision loops (e.g., OCR inference), instantiating static NumPy arrays (like perspective transform coordinates or convolution kernels) inside the loop introduces severe allocation overhead.
