...
## 2025-03-21 - Extract Static Arrays to Module-Level Constants
**Learning:** Instantiating static NumPy arrays (like perspective warp coordinates or convolution kernels) inside high-frequency vision loops introduces severe allocation overhead.
**Action:** Always pre-compute and cache static arrays as module-level constants to optimize performance.
