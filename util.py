...
# Pre-computed sets for O(1) lookups during fast OCR validation
...
def format_license(text):
    ...
    # If the last character is explicitly a valid letter, it's a motorcycle.
    # A valid letter is implicitly not a digit.
    ...
    # Use list comprehension and string join for O(1) dictionary mapping
