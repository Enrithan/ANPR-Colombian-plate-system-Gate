...
def format_license(text):
    ...
    is_motorcycle = False
    # If the last character is explicitly a letter, it's a motorcycle plate format: AAA12A
    ...
    for j, c in enumerate(text):
        if j < 3: # Always letters
            license_plate_.append(dict_int_to_char.get(c, c))
        elif j < 5: # Always numbers
            license_plate_.append(dict_char_to_int.get(c, c))
