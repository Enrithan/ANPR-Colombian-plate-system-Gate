...
VALID_LAST_CHARS = frozenset(string.ascii_uppercase) | frozenset(dict_int_to_char.keys()) | frozenset('0123456789') | frozenset(dict_char_to_int.keys())
LITERAL_DIGITS = frozenset('0123456789')
...
def license_complies_format(text):
    ...
    return text[5] in VALID_LAST_CHARS
...
def format_license(text):
    ...
    if text[5] in string.ascii_uppercase and text[5] not in LITERAL_DIGITS:
        is_motorcycle = True
