...
# Pre-computed collections for O(1) lookups
...
STRICT_LETTERS = frozenset(string.ascii_uppercase)
STRICT_NUMBERS = frozenset('0123456789')
...
def format_license(text):
    ...
    if c5 in STRICT_LETTERS and c5 not in STRICT_NUMBERS:
        is_motorcycle = True
    ...
    # Use list comprehension and join for faster string construction
    return "".join([
